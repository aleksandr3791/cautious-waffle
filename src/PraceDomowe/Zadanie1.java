...
//ZLicz wystapienia poszczegolnych liczb w tablicy - stworz elastyczna metode, ktora zadziala dla innych tablic
...
public class Zadanie1 {
    ...
    public static void liczWystapienia(int [] numbers) {
        ...
        System.out.println("Ilosc elementow to: " + occurences.size());
